...
// macro to get the current state from a task
...
// macro to switch state from a task
#define SWITCH_ST_FROM_TASK(state) __task->system->sys_state = state; xSemaphoreGive(__task->system->sys_new_state)
